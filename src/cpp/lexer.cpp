...
std::vector<Token> lex(const std::string& inputString) {
    ...
    while (pos < inputString.length()) {
        ...
        switch (currentChar) {
            case ';': addToken(TK_Semicolon, ";", column); break;
            case '(': addToken(TK_OpenParen, "(", column); break;
            case ')': addToken(TK_CloseParen, ")", column); break;
            case '{': addToken(TK_OpenBrace, "{", column); break;
            case '}': addToken(TK_CloseBrace, "}", column); break;
            case ',': addToken(TK_Comma, ",", column); break;
            default:
...
void display_tokens(const std::vector<Token>& tokens) {
    ...
    for (const auto& token : tokens) {
        ...
        switch (token.type) {
            case TK_Identifier: tokenType = "Identifier"; break;
            case TK_Argument: tokenType = "Argument"; break;
            case TK_String: tokenType = "String"; break;
            case TK_Semicolon: tokenType = "Semicolon"; break;
            case TK_Integer: tokenType = "Integer"; break;
            case TK_Float: tokenType = "Float"; break;
            case TK_MathOperator: tokenType = "MathOperator"; break;
            case TK_EqualsSign: tokenType = "EqualsSign"; break;
            case TK_TypeInteger: tokenType = "TypeInteger"; break;
            case TK_TypeChar: tokenType = "TypeChar"; break;
            case TK_TypeFloat: tokenType = "TypeFloat"; break;
            case TK_TypeString: tokenType = "TypeString"; break;
            case TK_OpenParen: tokenType = "OpenParen"; break;
            case TK_CloseParen: tokenType = "CloseParen"; break;
            case TK_OpenBrace: tokenType = "OpenBrace"; break;
            case TK_CloseBrace: tokenType = "CloseBrace"; break;
            case TK_Comma: tokenType = "Comma"; break;
            case TK_LogicalOperator: tokenType = "LogicalOperator"; break;
            case TK_ComparisonOperator: tokenType = "ComparisonOperator"; break;
            case TK_Unknown: tokenType = "Unknown"; break;
        }
